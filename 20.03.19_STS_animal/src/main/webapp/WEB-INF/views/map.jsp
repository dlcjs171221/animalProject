...
<script>
	...
	var options = { //지도를 생성할 때 필요한 기본 옵션
		center: new kakao.maps.LatLng(35.222687, 126.881613), //지도의 중심좌표.
	...
	// 주소로 좌표를 검색합니다
	geocoder.addressSearch( '${caraAddr }' , function(result, status) {
	    ...
	    // 정상적으로 검색이 완료됐으면 
	     if (status === kakao.maps.services.Status.OK) {
	        ...
	        var infowindow = new kakao.maps.InfoWindow({
	            content: '<div class="marker">한국아이티인재개발학원</div>'
	        });
