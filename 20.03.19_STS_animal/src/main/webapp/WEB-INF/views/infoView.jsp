		...
		<table style=" text-align: center; width: 800px; height:500px; margin: 0 auto; margin-top: 100px;">
			...
			<tr>
				<td colspan="4" style="text-align: right;">
					<input type="button" value="목록" class="btn btn-info btn-xs"  style="color: white;" onclick="javascript:location.href='bbslist.inc?bname=${vo.bname}&nowPage=${param.nowPage }'"/>
					<input type="button" value="수정" class="btn btn-info btn-xs"  style="color: white;" onclick="javascript:location.href='infoedit.inc?b_idx=${vo.b_idx}&nowPage=${param.nowPage }'"/>
				</td>
