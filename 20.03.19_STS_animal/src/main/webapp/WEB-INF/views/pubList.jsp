	        ...
	        <tfoot>
	       		<tr>
	       			<td colspan="4" style="text-align: right;">
		       			...
		       			<button type="button" name="pubwrite" class="btn btn-info btn-xs"  style="color: white;" value="정책쓰기" onclick="javascript:location.href='infowrite.inc?bname=정책'">정책쓰기</button>
			        </td>	
	        	</tr>
	        </tfoot>	
	      </table>
